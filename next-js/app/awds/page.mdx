...
<ComponentWrapper>
  <div className="flex flex-col gap-6">
    <Variant label=".text-preset-1(-bold)" meta="(Used for really small labels)">
    ...
    <Variant label=".text-preset-4(-bold)" meta="(Used for heading levels 4, 5, and 6)">
  ...
  <div className="grid gap-4">
    ...
    <Variant label="With React node description">
      <EmptyState
        ...
        description={
          <span>
            This work is on the <a href="#">Bucket List</a>, but I haven't performed it yet.
          </span>
        }
      />
    </Variant>
