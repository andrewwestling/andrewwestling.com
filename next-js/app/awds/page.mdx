...
<ComponentWrapper>
  <div className="grid gap-6">
    ...
    <div className="flex flex-col gap-2">
      <label className="text-xs text-muted">With Upcoming Date</label>
      <ConcertListItem
...
<ComponentWrapper>
  <div className="grid gap-4">
    ...
    <div className="flex flex-col gap-2">
      <label className="text-xs text-muted">Work Example</label>
      <ListItem
    ...
    <div className="flex flex-col gap-2">
      <label className="text-xs text-muted">Work Example, Bucket List</label>
      <ListItem
        title="Symphony No. 1 in E Minor"
        href="/music/works/sibelius-symphony-no-1-in-e-minor"
        stats={["by Jean Sibelius"]}
    ...
    <div className="flex flex-col gap-2">
      <label className="text-xs text-muted">Work Example, Bucket List, Played</label>
      <ListItem
        title="Symphony No. 1 in E Minor"
        href="/music/works/sibelius-symphony-no-1-in-e-minor"
        stats={["by Jean Sibelius"]}
...
<ComponentWrapper>
  <div className="grid gap-4">
    <div className="flex flex-col gap-2 w-fit">
      <label className="text-xs text-muted">Not played</label>
      <BucketList />
    </div>
    <div className="flex flex-col gap-2 w-fit">
      <label className="text-xs text-muted">Played</label>
      <BucketList played />
    </div>
  </div>
</ComponentWrapper>
...
<ComponentWrapper>
  <div className="grid gap-4">
    <div className="flex flex-col gap-2">
      <label className="text-xs text-muted">With upcoming date; without ticket URL</label>
      <AttendActions concert={sampleConcertWithoutTicketUrl} />
    </div>
    <div className="flex flex-col gap-2">
      <label className="text-xs text-muted">With upcoming date; with ticket URL</label>
