...
import {
  ...
  sampleConcertWithLiveStreamUrl,
  sampleConcertForNavPrev,
  sampleConcertForNavNext,
...
I got this idea from <ExternalLink href="https://danmall.com/posts/typography-in-design-systems">Dan Mall</ExternalLink>, and I use 7 because of <ExternalLink href="https://en.wikipedia.org/wiki/The_Magical_Number_Seven,_Plus_or_Minus_Two">The magical number seven, plus or minus two</ExternalLink>.

There's a `-bold` variant for each preset, which boldens it correctly according to the existing font-weight.

export const SAMPLE_TEXT = "This is an example of this preset.";
export const SAMPLE_TEXT_BOLD = "This is an example of this preset, but bold.";

<ComponentWrapper>
  <div className="flex flex-col gap-6">
    <Variant
      label=".text-preset-1(-bold)"
      meta="(Used for really small labels)"
    >
      <p className="text-preset-1">{SAMPLE_TEXT}</p>
      <p className="text-preset-1-bold">{SAMPLE_TEXT_BOLD}</p>
    </Variant>
    <Variant label=".text-preset-2(-bold)" meta="(Used for small labels)">
      <p className="text-preset-2">{SAMPLE_TEXT}</p>
      <p className="text-preset-2-bold">{SAMPLE_TEXT_BOLD}</p>
    </Variant>
    <Variant label=".text-preset-3(-bold)" meta="(The default body text)">
      <p className="text-preset-3">{SAMPLE_TEXT}</p>
      <p className="text-preset-3-bold">{SAMPLE_TEXT_BOLD}</p>
    </Variant>
    <Variant
      label=".text-preset-4(-bold)"
      meta="(Used for heading levels 4, 5, and 6)"
    >
      <p className="text-preset-4">{SAMPLE_TEXT}</p>
      <p className="text-preset-4-bold">{SAMPLE_TEXT_BOLD}</p>
    </Variant>
    <Variant label=".text-preset-5(-bold)" meta="(Used for heading level 3)">
      <p className="text-preset-5">{SAMPLE_TEXT}</p>
      <p className="text-preset-5-bold">{SAMPLE_TEXT_BOLD}</p>
    </Variant>
    <Variant label=".text-preset-6(-bold)" meta="(Used for heading level 2)">
      <p className="text-preset-6">{SAMPLE_TEXT}</p>
      <p className="text-preset-6-bold">{SAMPLE_TEXT_BOLD}</p>
    </Variant>
    <Variant label=".text-preset-7(-bold)" meta="(Used for heading level 1)">
      <p className="text-preset-7">{SAMPLE_TEXT}</p>
      <p className="text-preset-7-bold">{SAMPLE_TEXT_BOLD}</p>
    </Variant>
  </div>
</ComponentWrapper>
...
The examples below show how Markdown elements will render within MDX:

### Bold and Italic

**This is bold**, _this is italic_, _**this is bold and italic**_
...
> With multiple lines.
>
> Continuing more text in the block quote. If it gets too long, the line will wrap.
...
This component is used to display a consistent empty state message when there is no content to show. It supports a title and an optional description.
  ...
  <div className="grid gap-4">
    ...
    <Variant label="With description">
      <EmptyState
        ...
        description="There are no upcoming concerts scheduled at this time."
      />
    </Variant>
    <Variant label="With React node description">
      <EmptyState
        title="No concerts yet"
        description={
          <span>
            This work is on the <a href="#">Bucket List</a>, but I haven't
            performed it yet.
          </span>
        }
      />
    ...
    <Header>
      <Breadcrumbs
        ...
        crumbs={[
          ...
          { label: "A custom breadcrumb", href: "/awds" },
        ]}
      />
    </Header>
  </Variant>
...
export const ENABLE_OVERFLOW = "max-w-container mx-auto px-4";

<ComponentWrapper>
  <div className={`grid gap-4 ${ENABLE_OVERFLOW}`}>
    ...
    <Variant label="Overflow" className="max-w-[500px] rounded-t border-t border-r border-fuchsia-500 border-dashed">
      <BreadcrumbsSlot path="/music/concerts/202411171500" />
    </Variant>
...
<ComponentWrapper>
  <div className="grid gap-4">
    ...
    <Variant label="ButtonLink external">
      <ButtonLink external href="/awds">
        ButtonLink external
      </ButtonLink>
    </Variant>
    <Variant label="ButtonLink external with icon">
      <ButtonLink external href="/awds" icon="🚀">
...
<ComponentWrapper>
  <div className="grid gap-4">
    <Variant label="PageTitle">
      <PageTitle>Example Page Title</PageTitle>
    </Variant>
    <Variant label="SectionHeading">
...
<ComponentWrapper>
  <div className="grid gap-4">
    ...
    <Variant label="Concert Example with statsBadges (Today badge)">
      <ListItem
        title="Example Concert"
        href="/music/concerts/example"
        stats={["January 1, 2024"]}
...
This badge is used to indicate concerts happening today.
...
<ComponentWrapper>
  <CalendarUrlCopy
    calendarUrl={"https://andrewwestling.com/music/upcoming.ics"}
  />
</ComponentWrapper>
...
<ComponentWrapper>
  <div className="grid gap-4">
    ...
    <Variant label="With upcoming date; with live stream URL">
      <AttendActions concert={sampleConcertWithLiveStreamUrl} />
    </Variant>
  </div>
</ComponentWrapper>
...
<ComponentWrapper>
  <div className="grid gap-4">
    <Variant label="With both prev and next">
      <div className="flex items-start justify-between gap-4">
        <div className="text-2xl">Page Title</div>
        <BackForwardNavigation
          prev={sampleConcertForNavPrev}
          next={sampleConcertForNavNext}
          getHref={(concert) => concert.slug}
          getTooltip={(concert) => concert.title}
        />
      </div>
    </Variant>
    <Variant label="At the beginning (no prev)">
      <div className="flex items-start justify-between gap-4">
        <div className="text-2xl">Page Title</div>
        <BackForwardNavigation
          prev={null}
    ...
    <Variant label="At the end (no next)">
      <div className="flex items-start justify-between gap-4">
        <div className="text-2xl">Page Title</div>
        <BackForwardNavigation
          prev={sampleConcertForNavPrev}
